...
router.post('/', async (req, res) => {
  try {
    ...
    const [result] = await db.execute("INSERT INTO bank_accounts (account_holder_name, account_no, ifsc_code, bank_name, branch_name, upi_id, upi_number, opening_balance, notes, is_default) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)",
